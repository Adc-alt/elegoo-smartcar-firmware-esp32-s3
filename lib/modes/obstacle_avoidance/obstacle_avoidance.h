...
private:
  ...
  // Constantes
  static constexpr int kObstacleThresholdCm   = 20;   // Umbral crítico para detenerse
  static constexpr int kMinFreeDistanceCm     = 20;   // Distancia mínima para considerar dirección libre
  static constexpr uint8_t kSpeed             = 30;   // Velocidad del coche
  static constexpr unsigned long kTurnDurationMs     = 800;  // Tiempo para girar en evasión normal
  static constexpr unsigned long kBackupDurationMs   = 1000; // Tiempo para retroceder
  static constexpr unsigned long kEscapeTurnLeftMs  = 800;  // Tiempo para girar izquierda en escape
  static constexpr unsigned long kEscapeTurnRightMs = 300;  // Tiempo para girar derecha en escape
  static constexpr uint8_t kServoCenterAngle  = 90;   // Ángulo central del servo
